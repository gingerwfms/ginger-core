 ...
 */
namespace GingerCore\Repository\Adapter;
...
interface CrudRepositoryAdapterInterface
{
     ...
     * 
     * @throws \GingerCore\Exception\RuntimeException If create could not be performed
     */
     ...
     * @return void
     * 
     * @throws \GingerCore\Exception\RuntimeException If update could not be performed
     */
     ...
     * @return void
     * 
     * @throws \GingerCore\Exception\RuntimeException If deletion could not be performed
     */
